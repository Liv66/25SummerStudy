...
def OSM_run(problem_info, time_limit=60):
...
#    # 결과 형식에 맞춰 반환
#    if final_solution and final_solution[1] != float('inf'):
#        best_routes = final_solution[0]
#        best_cost = final_solution[1]
#        print(f"ACO Solver best cost: {best_cost:.2f}")
#        print(best_routes)
#        return best_routes
#    else:
#        print("ACO Solver could not find a valid solution.")
#        return []  # 해를 찾지 못한 경우 빈 리스트 반환


if __name__ == "__main__":
    file_path = 'C:/Users/risklab/Desktop/code/25SummerStudy/instances/problem_50_0.5.json'
