...
from OSM_util import bin_packing, multiple_knapsack, get_distance, two_opt, plot_cvrp
...
def OSM_main():
    ...
    K = bin_packing(demands, capa)  # ���� ��
    print(f'# of vehicles {K}')
    knapsack_sol = multiple_knapsack(demands, capa, K)  # ��� ���� Ž��
    depot_coord = (12000, 16000)  # depot ��� ��ǥ
    all_node_coord = nodes_coord + [depot_coord]
    dist_matrix = get_distance(all_node_coord)  # �Ÿ� ��� ���
