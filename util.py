    ...
    while improved:
        ...
        for i in range(1, len(nodes) - 1):
            for j in range(i + 1, len(nodes)):
                ...
                before = (dist_matrix[result_route[i - 1]][result_route[i]] + dist_matrix[result_route[j]][
                    result_route[j + 1]])
                after = (dist_matrix[result_route[i - 1]][result_route[j]] + dist_matrix[result_route[i]][
                    result_route[j + 1]])
                if after - before < 0:
