...
def run_sscflp_vrpb(n, m, vehicle_capacity, demands, node_types, coords_dict, dist_matrix):
    ...
    for i in range(m):
        ...
        _, result_route = two_opt(depot_idx, route, dist_matrix, nodes_coord=False, show=False)
...
def plot_routes_with_node_types(routes, coords_dict, node_type, match_pairs=None, line_routes=None, back_routes=None):
    ...
    plt.title("Vehicle Routes with Linehaul-Backhaul Connection and Depot")
    plt.axis("equal")
    plt.grid(True)
